---
layout: page
title: "Согласование проекта размещения средств наружной информации: Добавление в реестр записи о согласовании вывески: аренда, административное здание"
permalink: /uslugi/signboard_lease_no_living
---

## Схема
```json
{% include schemas/document/ru/uslugi/45_signboard_lease_no_living.json %}
```
