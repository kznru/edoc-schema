...
Заявление, как и любой другой документ, использует стандартный [контейнер для хранения документов](/schemas/document/ru/document.json) ([пример данных](/schemas/document/ru/document_example.json)).
